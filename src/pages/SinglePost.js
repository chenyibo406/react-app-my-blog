      ...
      {isLoading ? (
        ...
        <section className="px-5 xl:max-w-6xl xl:mx-auto pb-20">
          ...
          <button>
            <Link
              to="/blog"
              className="py-1 px-2 rounded shadow text-white bg-black hover:bg-transparent border-1 border-black transition-all duration-500 hover:text-black font-bold"
            >
              Read more articles
            </Link>
          </button>
